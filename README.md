...
## Оглавление
1.	[Установка Docker Engine](#Установка-Docker-Engine)
2.	[Создание Docker-образа](#Создание-Docker-образа)
3.	[Запуск контейнера и основные команды Docker](#Запуск-контейнера-и-основные-команды-Docker)
4.	[Загрузка образа в сеть](#Загрузка-образа-в-сеть)
...
Для начала мы создаем директорию, в которой будет храниться наш проект, и переходим в нее:
...
Мы можем проверить, что файл был действительно создан, при помощи команды:
...
В браузере можно будет увидеть следующее:
